...
% ═════════════════════════════════════════════════════════════════════════════
\part*{Part III --- Automation}
\addcontentsline{toc}{part}{Part III --- Automation}
...
Privilege levels, password encryption, SSH-only management & \textit{planned} & ---  \\
Two additional security measures         & \textit{planned} & ---  \\
\bottomrule
\end{tabular}
\end{table}
